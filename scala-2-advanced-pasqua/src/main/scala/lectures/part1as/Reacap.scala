...
object Reacap extends App {
  ...
  val aDog: Animal = new Dog // subtyping plymorphism
  ...
  // exceptions and ry/catch/finally
  ...
  // Scala collections: Sqs, Arrays, Lists, Vectors, Maps, Tuples
  val aMap = Map(
    "Daniel" -> 759,
    "Jess" -> 555
  )
